    ...
    >
      ...
      >
        <HeadlessMenu.Items
          as="div"
          className={twMerge([
            "p-2 shadow-xl shadow-slate-200 bg-white border-transparent rounded-2xl dark:bg-darkmode-600 dark:border-transparent",
            className,
          ])}
          {...props}
        >
...
Menu.Item = ({
  ...
  return (
    <HeadlessMenu.Item
      as="a"
      className={twMerge([
        "cursor-pointer flex items-center p-2 transition duration-300 ease-in-out rounded-xl hover:bg-slate-200/60 dark:bg-darkmode-600 dark:hover:bg-darkmode-400",
        className,
      ])}
      {...props}
    >
...
Menu.Divider = (props: React.ComponentPropsWithoutRef<"div">) => {
  return (
    <div
      className={twMerge([
        "h-px my-2 -mx-2 bg-slate-50 dark:bg-darkmode-400",
        props.className,
      ])}
    ></div>
  );
